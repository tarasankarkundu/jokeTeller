...
(function(){
    ...
    const tellJoke = (joke) => {
        ...
        key: '6ea549ce4320481d8a70bb8236a7e9f1',
        src: joke,
        hl: 'en-us',
        r: 0, 
        c: 'mp3',
    ...
    const fetchJoke = async() => {
        ...
        try {
            const response = await fetch("https://sv443.net/jokeapi/v2/joke/Programming,Miscellaneous?blacklistFlags=nsfw,religious,political,racist,sexist");
    ...
    audioElement.addEventListener('ended', enalbleButton);
})()
